\inputencoding{utf8}
\HeaderA{simulation.plot}{Create Simulation Plots}{simulation.plot}
\keyword{method}{simulation.plot}
%
...
plots is generated. See \code{vignette('scaRabee',package='scaRabee')} for 
more details. \code{simulation.plot} is typically not called directly by
users.
\end{Description}
%
\begin{Usage}
...
by \code{simulation.report} and containing the following columns: \begin{description}
...
%
\begin{SeeAlso}\relax
\code{\LinkA{simulation.report}{simulation.report}}
\end{SeeAlso}
