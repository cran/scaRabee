...
if (interactive()){
  cat('\nExample 4 - Estimation of a model defined with ordinary differential equations\n\n')
...
# Set file files
old.wd <- getwd()
wd <- paste(wd,'example.4/',sep='')
ana.file <- paste(wd,'example.4.R',sep='')
