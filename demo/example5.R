...
if (interactive()){
  cat('\nExample 5 - Simulation of a model defined with delay differential equations\n\n')
...
# Set file files
old.wd <- getwd()
wd <- paste(wd,'example.5/',sep='')
ana.file <- paste(wd,'example.5.R',sep='')
