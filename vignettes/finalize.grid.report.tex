\inputencoding{utf8}
\HeaderA{finalize.grid.report}{Finalize Direct Grid Search Report}{finalize.grid.report}
\keyword{method}{finalize.grid.report}
%
...
%
\begin{SeeAlso}\relax
\code{\LinkA{scarabee.gridsearch}{scarabee.gridsearch}},
\end{SeeAlso}
